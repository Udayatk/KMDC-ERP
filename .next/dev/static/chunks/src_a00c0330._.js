...
const MainLayout = ({ children })=>{
    ...
    const { currentULB, setCurrentULB } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$layout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppContext"])();
...
_s(MainLayout, "VSdWxJlSbeCO6Oa5nTaTDwM4jmc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$layout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppContext"]
    ];
});
_c = MainLayout;
...
"[project]/src/app/user-directory/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const mockUsers = [
    {
        ...
        mobile: '9876543210',
        status: 'Active',
        email: 'rajesh.kumar@kmds.gov.in',
    ...
    },
    {
        ...
        mobile: '9876543211',
        status: 'Active',
        email: 'priya.sharma@kmds.gov.in',
    ...
    },
    {
        ...
        mobile: '9876543212',
        status: 'Inactive',
        email: 'suresh.babu@kmds.gov.in',
        dateOfBirth: '1982-11-08',
        joiningDate: '2008-09-20',
        department: 'Engineering'
    },
    {
        id: '4',
        ...
        mobile: '9876543213',
        status: 'Active',
        email: 'anjali.reddy@kmds.gov.in',
    ...
    },
    {
        ...
        mobile: '9876543214',
        status: 'Active',
        email: 'mahesh.gowda@kmds.gov.in',
...
function UserDirectoryPage() {
    ...
    const [designationFilter, setDesignationFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('All');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserDirectoryPage.useEffect": ()=>{
            let filtered = users;
            if (searchTerm) {
                filtered = filtered.filter({
                    "UserDirectoryPage.useEffect": (user)=>user.name.toLowerCase().includes(searchTerm.toLowerCase()) || user.employeeId.toLowerCase().includes(searchTerm.toLowerCase())
                }["UserDirectoryPage.useEffect"]);
            }
            if (statusFilter !== 'All') {
                filtered = filtered.filter({
                    "UserDirectoryPage.useEffect": (user)=>user.status === statusFilter
                }["UserDirectoryPage.useEffect"]);
            }
            if (designationFilter !== 'All') {
                filtered = filtered.filter({
                    "UserDirectoryPage.useEffect": (user)=>user.designation === designationFilter
                }["UserDirectoryPage.useEffect"]);
            }
    ...
    const handleCreateUser = ()=>{
        // This will be implemented with the drawer component
        setSnackbar({
            open: true,
            message: 'Create user functionality will be implemented!',
            severity: 'info'
        });
    };
    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Chip$2f$Chip$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Chip$3e$__["Chip"], {
                    ...
                    fileName: "[project]/src/app/user-directory/page.tsx",
                    lineNumber: 207,
                    columnNumber: 9
                }, this)
        },
        {
            ...
            width: 120,
            getActions: (params)=>[
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$data$2d$grid$2f$esm$2f$components$2f$cell$2f$GridActionsCellItem$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GridActionsCellItem"], {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                            ...
                            children: "Manage user accounts and employee information"
                        }, void 0, false, {
                            fileName: "[project]/src/app/user-directory/page.tsx",
                            lineNumber: 253,
                            columnNumber: 11
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Select$2f$Select$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Select$3e$__["Select"], {
                                            ...
                                            children: [
                                                ...
                                                getUniqueValues('designation').map((designation)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$MenuItem$2f$MenuItem$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__MenuItem$3e$__["MenuItem"], {
                                                        value: designation,
                                                        children: designation
                                                    }, designation, false, {
                                                        fileName: "[project]/src/app/user-directory/page.tsx",
...
_s(UserDirectoryPage, "M0AnkLeh7o3wE0z6g8M6TtXKMOw=");
_c = UserDirectoryPage;
var _c;
__turbopack_context__.k.register(_c, "UserDirectoryPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_a00c0330._.js.map