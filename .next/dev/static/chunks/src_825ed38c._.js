...
const ForgotPassword = ({ onBackToLogin })=>{
    ...
    const [canResendOtp, setCanResendOtp] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ForgotPassword.useEffect": ()=>{
            if (otpExpiry) {
                const checkExpiry = {
                    "ForgotPassword.useEffect.checkExpiry": ()=>{
                        if (new Date() > otpExpiry) {
                            setErrors({
                                otp: 'OTP has expired. Please generate a new OTP.'
                            });
                            setOtpSent(false);
                        }
                    }
    ...
    const handleInputChange = (field)=>(event)=>{
            ...
            if ((field === 'newPassword' || field === 'confirmPassword') && value.length > 12) {
                return;
            }
            setFormData((prev)=>({
                    ...prev,
    ...
    const validatePassword = ()=>{
        ...
        } else if (formData.newPassword.length < 8 || formData.newPassword.length > 12) {
            newErrors.newPassword = 'Password should be between 8 and 12 characters';
        } else if (!passwordRegex.test(formData.newPassword)) {
            newErrors.newPassword = 'Password must contain at least 1 capital letter, 1 small letter, 1 special character and 1 number';
        }
    ...
    const handleGenerateOtp = async ()=>{
        ...
        // Simulate employee ID validation
        const isValidEmployee = formData.employeeId === '123456'; // Mock validation
        if (!isValidEmployee) {
            setErrors({
                employeeId: 'Entered Employee Id does not exist or ID is not active'
            });
            return;
        }
        // Generate OTP
        ...
        setResendTimer(30);
        // Set OTP expiry to 11:59:59 PM of current date
    ...
    const handleVerifyOtp = async ()=>{
        ...
        const isValidOtp = formData.otp === '123456'; // Mock validation
        if (!isValidOtp) {
            setErrors({
                otp: 'Incorrect OTP'
            });
        ...
        // Disable employee ID and OTP fields, enable password fields
        setActiveStep(2);
    };
    const handleContinue = ()=>{
        if (activeStep === 0 && otpSent && validateOtp()) {
            handleVerifyOtp();
        }
    };
                            ...
                            activeStep === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$TextField$2f$TextField$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__TextField$3e$__["TextField"], {
                                        ...
                                        sx: {
                                            '& .MuiOutlinedInput-root': {
                                                borderRadius: 3,
                                                background: otpSent ? 'rgba(0,0,0,0.05)' : 'rgba(255,255,255,0.8)',
                                                '&:hover fieldset': {
                                                    borderColor: '#3b82f6',
                                                    borderWidth: 2
                                                },
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Button$2f$Button$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Button$3e$__["Button"], {
                                        ...
                                        disabled: !canResendOtp || otpSent,
                                        sx: {
                                            background: !canResendOtp || otpSent ? '#64748b' : 'linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%)',
                                            borderRadius: 3,
                                            py: 1.5,
                                            fontSize: '16px',
                                            fontWeight: 600,
                                            textTransform: 'none',
                                            boxShadow: !canResendOtp || otpSent ? 'none' : '0 4px 16px rgba(30,58,138,0.3)',
                                            '&:hover': {
                                                background: !canResendOtp || otpSent ? '#64748b' : 'linear-gradient(135deg, #1e40af 0%, #2563eb 100%)',
                                                transform: !canResendOtp || otpSent ? 'none' : 'translateY(-2px)',
                                                boxShadow: !canResendOtp || otpSent ? 'none' : '0 6px 20px rgba(30,58,138,0.4)'
                                            },
                                            transition: 'all 0.3s ease'
                                        },
                                        children: [
                                            otpSent ? '✅ OTP Sent' : '📱 Generate OTP',
                                            !canResendOtp && ` (${resendTimer}s)`
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/components/auth/ForgotPassword.tsx",
                                        lineNumber: 438,
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$TextField$2f$TextField$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__TextField$3e$__["TextField"], {
                                                ...
                                                sx: {
                                                    '& .MuiOutlinedInput-root': {
                                                        borderRadius: 3,
                                                        background: activeStep > 0 ? 'rgba(0,0,0,0.05)' : 'rgba(255,255,255,0.8)',
                                                        '&:hover fieldset': {
                                                            borderColor: '#3b82f6',
                                                            borderWidth: 2
                                                        },
                                    ...
                                    canResendOtp && otpSent && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Button$2f$Button$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Button$3e$__["Button"], {
                                        variant: "outlined",
                                        onClick: handleGenerateOtp,
                                        sx: {
                                            borderColor: '#3b82f6',
                            ...
                            activeStep === 2 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Alert$2f$Alert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Alert$3e$__["Alert"], {
                                        ...
                                        children: "✅ OTP verified successfully. Please set your new password."
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/auth/ForgotPassword.tsx",
                                        lineNumber: 615,
                                        columnNumber: 17
...
_s(ForgotPassword, "d8VvLDRsiJJViPV6IYNYa/Rvtvc=");
_c = ForgotPassword;
...
const LoginPage = ()=>{
    _s();
    const [tabValue, setTabValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    ...
    const [otpGenerated, setOtpGenerated] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const handleLogin = async ()=>{
        if (isLocked) {
            setErrors({
                general: 'User ID is locked. Change password using forgot password link'
            });
            return;
        }
        if (!validateForm()) {
        ...
        const isValidEmployee = formData.employeeId === '123456';
        const isValidPassword = formData.password === 'password123';
        if (!isValidEmployee) {
            setErrors({
                general: 'Please Enter valid employee id'
            });
            setIsLoading(false);
            return;
        }
    ...
    const generateOTP = async ()=>{
        if (!formData.employeeId) {
            setErrors({
                employeeId: 'Please enter Employee ID first'
            });
            return;
        }
        setIsLoading(true);
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Card$2f$Card$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Card$3e$__["Card"], {
                            ...
                            sx: {
                                ...
                                '&::before': {
                                    ...
                                    right: 0,
                                    height: '6px',
                                    background: 'linear-gradient(90deg, #1e3a8a, #3b82f6, #06d6a0, #ffd60a)',
                                    zIndex: 1
                                }
                            },
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                                ...
                                                children: "Access your municipal administration portal"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/auth/LoginPage.tsx",
                                                lineNumber: 403,
                                                columnNumber: 19
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Tabs$2f$Tabs$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Tabs$3e$__["Tabs"], {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Tab$2f$Tab$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Tab$3e$__["Tab"], {
                                                icon: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$VpnKey$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                                    fileName: "[project]/src/components/auth/LoginPage.tsx",
                                                    lineNumber: 453,
                                                    columnNumber: 27
                                                }, void 0),
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                                    ...
                                                    children: "Coming Soon - Access municipal services as a citizen"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/auth/LoginPage.tsx",
                                                    lineNumber: 477,
                                                    columnNumber: 21
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TabPanel, {
                                        ...
                                        children: [
                                            ...
                                            showSuccessAnimation && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Alert$2f$Alert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Alert$3e$__["Alert"], {
                                                severity: "success",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Button$2f$Button$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Button$3e$__["Button"], {
                                                        ...
                                                        sx: {
                                                            background: otpGenerated ? 'linear-gradient(135deg, #059669 0%, #10b981 100%)' : 'linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%)',
                                                            borderRadius: 3,
                                                            py: 2,
                                                            fontSize: '16px',
                                                            fontWeight: 700,
                                                            textTransform: 'none',
                                                            boxShadow: otpGenerated ? '0 6px 24px rgba(5,150,105,0.4)' : '0 6px 24px rgba(30,58,138,0.4)',
                                                            '&:hover': {
                                                                background: otpGenerated ? 'linear-gradient(135deg, #047857 0%, #059669 100%)' : 'linear-gradient(135deg, #1e40af 0%, #2563eb 100%)',
                                                                transform: 'translateY(-2px)',
                                                                boxShadow: otpGenerated ? '0 8px 32px rgba(5,150,105,0.5)' : '0 8px 32px rgba(30,58,138,0.5)'
                                                            },
                                                            '&:disabled': {
                                                                background: '#94a3b8',
                                                                color: 'white'
                                                        ...
                                                        children: [
                                                            ...
                                                            isLoading ? 'Generating...' : otpGenerated ? '✅ OTP Sent' : 'Generate OTP'
                                                        ]
                                                    }, void 0, true, {
                                                        fileName: "[project]/src/components/auth/LoginPage.tsx",
                                                        lineNumber: 604,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$TextField$2f$TextField$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__TextField$3e$__["TextField"], {
                                                        ...
                                                        sx: {
                                                            '& .MuiOutlinedInput-root': {
                                                                borderRadius: 3,
                                                                background: otpGenerated ? 'rgba(255,255,255,0.9)' : 'rgba(0,0,0,0.05)',
                                                                '&:hover fieldset': {
                                                                    borderColor: '#3b82f6',
                                                                    borderWidth: 2
                                                                },
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Button$2f$Button$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Button$3e$__["Button"], {
                                                        ...
                                                        sx: {
                                                            background: isLocked ? '#64748b' : isLoading ? '#94a3b8' : 'linear-gradient(135deg, #059669 0%, #10b981 100%)',
                                                            borderRadius: 3,
                                                            py: 2.5,
                                                            fontSize: '20px',
                                                            fontWeight: 800,
                                                            textTransform: 'none',
                                                            boxShadow: isLocked || isLoading ? 'none' : '0 8px 32px rgba(5,150,105,0.4)',
                                                            '&:hover': {
                                                                background: isLocked ? '#64748b' : isLoading ? '#94a3b8' : 'linear-gradient(135deg, #047857 0%, #059669 100%)',
                                                                transform: isLocked || isLoading ? 'none' : 'translateY(-3px)',
                                                                boxShadow: isLocked || isLoading ? 'none' : '0 12px 40px rgba(5,150,105,0.6)'
                                                            },
                                                            transition: 'all 0.4s ease'
                                                        },
                                                        ...
                                                        }, void 0, true) : isLocked ? '🔒 Account Locked' : '🚀 Login to Dashboard'
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/auth/LoginPage.tsx",
                                                        lineNumber: 750,
                                                        columnNumber: 21
...
_s(LoginPage, "TdBVmuoEMoq0KrmNQL69RAHuVEM=");
_c1 = LoginPage;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$Store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/icons-material/esm/Store.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$Announcement$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mui/icons-material/esm/Announcement.js [app-client] (ecmascript)");
                            ...
                            children: [
                                ...
                                'Contact'
                                    ...
                                    sx: {
                                        ...
                                        minHeight: '48px',
                                        borderRadius: 0,
                                        borderBottom: item === 'Home' ? '3px solid #60a5fa' : '3px solid transparent',
                                        '&:hover': {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Grid$2f$Grid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Grid$3e$__["Grid"], {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                            ...
                                            children: "Streamlining municipal operations, enhancing citizen services, and ensuring transparent governance across Karnataka."
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/LandingPage.tsx",
                                            lineNumber: 215,
                                            columnNumber: 29
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                                        variant: "h5",
                                                        fontWeight: "bold",
                                                        children: "Secure • Transparent • Efficient"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/LandingPage.tsx",
                                                        lineNumber: 278,
                                                        columnNumber: 41
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Grid$2f$Grid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Grid$3e$__["Grid"], {
                        ...
                        children: [
                            ...
                            },
                            {
                                ...
                                value: '45+',
                                icon: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$Store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                    fileName: "[project]/src/components/LandingPage.tsx",
                                    lineNumber: 295,
                                    columnNumber: 77
                                }, ("TURBOPACK compile-time value", void 0)),
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Container$2f$Container$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Container$3e$__["Container"], {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                            ...
                            children: "Comprehensive digital solutions designed to empower municipal administration and enhance citizen engagement."
                        }, void 0, false, {
                            fileName: "[project]/src/components/LandingPage.tsx",
                            lineNumber: 341,
                            columnNumber: 21
                            ...
                            children: [
                                {
                                    ...
                                    desc: 'End-to-end tracking of municipal infrastructure projects with trackable milestones and fund utilization.',
                                ...
                                },
                                {
                                    ...
                                    desc: 'Centralized registry of all municipal employees with transfer history, payload details, and service records.',
                                    icon: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$People$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                        fileName: "[project]/src/components/LandingPage.tsx",
                                        lineNumber: 355,
                                        columnNumber: 39
                                ...
                                },
                                {
                                    ...
                                    desc: 'Citizen-centric platform for lodging complaints and tracking their resolution status in real-time.',
                                    icon: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$Announcement$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                        fileName: "[project]/src/components/LandingPage.tsx",
                                        lineNumber: 360,
                                        columnNumber: 39
                                    }, ("TURBOPACK compile-time value", void 0))
                                },
                                {
                                    ...
                                    desc: 'Seamless processing of trade licenses, building plan approvals, and noc issuances.',
                                    icon: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$TouchApp$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                        fileName: "[project]/src/components/LandingPage.tsx",
                                        lineNumber: 365,
                                        columnNumber: 39
                                    }, ("TURBOPACK compile-time value", void 0))
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                            ...
                                            children: [
                                                ...
                                                "Visvesvaraya Tower, Dr. Ambedkar Veedhi,",
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("br", {}, void 0, false, {
                                                    fileName: "[project]/src/components/LandingPage.tsx",
                                                    lineNumber: 423,
                                                    columnNumber: 33
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                    ...
                                    children: "© 2024 Directorate of Municipal Administration, Government of Karnataka. All rights reserved."
                                }, void 0, false, {
                                    fileName: "[project]/src/components/LandingPage.tsx",
                                    lineNumber: 470,
                                    columnNumber: 25
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                    ...
                                    children: "Designed & Developed by KMDS IT Team"
                                }, void 0, false, {
                                    fileName: "[project]/src/components/LandingPage.tsx",
                                    lineNumber: 473,
                                    columnNumber: 25
...
//# sourceMappingURL=src_825ed38c._.js.map